...
set d "set gpsport \$port[lindex $argv 0]";
eval $d;
send_user "GPS is on port [lindex $argv 0], $gpsport\n";

# START PROCESS -- KERMIT FOR GPS MODEM
spawn kermit
expect {
...
set timeout 3
## OPEN THE PORT
send "set line $gpsport\r"
expect "\n>>"
## SPEED
send "set speed 4800\r"
## DUPLEX
set duplex half
expect "\n>>"
## FLOW CONTROL
